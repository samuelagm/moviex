...
func (cc *CommentCreate) SetNillableFilmID(id *int) *CommentCreate {
	if id != nil {
		cc = cc.SetFilmID(*id)
	}
	return cc
...
func (cc *CommentCreate) SetFilm(m *Movie) *CommentCreate {
	return cc.SetFilmID(m.ID)
}
